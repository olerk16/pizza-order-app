...
const appTemplate = ()=>(0, _litHtml.html)`
  ${(0, _headerJs.Header)()}
  ${(0, _navigationJs.Navigation)()}
  ${(0, _stateJs.state).currentPage === "home" ? (0, _homeJs.Home)() : (0, _stateJs.state).currentPage === "menu" ? (0, _menuJs.Menu)() : (0, _cartJs.Cart)()}
  ${(0, _footerJs.Footer)()}
`;
const renderApp = ()=>{
    (0, _litHtml.render)(appTemplate(), document.querySelector("#root"));
};
renderApp();

},{"lit-html":"1cmQt","./components/Header.js":"hsJbF","./components/Navigation.js":"ixx0n","./components/Home.js":"hcu4N","./components/Menu.js":"auGqW","./components/Cart.js":"h8J3U","./components/Footer.js":"8pPOA","./state/state.js":"k3jRp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1cmQt":[function(require,module,exports) {
/**
 * @license
...
var _litHtml = require("lit-html");
const Header = ()=>(0, _litHtml.html)`
  <header>
    <h1>Pizza Order App</h1>
  </header>
`;

},{"lit-html":"1cmQt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ixx0n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Navigation", ()=>Navigation);
var _litHtml = require("lit-html");
var _stateJs = require("../state/state.js");
const Navigation = ()=>(0, _litHtml.html)`
  <nav>
    <ul>
      <li><a href="#" @click=${()=>(0, _stateJs.navigate)("home")}>Home</a></li>
      <li><a href="#" @click=${()=>(0, _stateJs.navigate)("menu")}>Menu</a></li>
      <li><a href="#" @click=${()=>(0, _stateJs.navigate)("cart")}>Cart</a></li>
    </ul>
  </nav>
`;

},{"lit-html":"1cmQt","../state/state.js":"k3jRp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k3jRp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../index.js":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hcu4N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Home", ()=>Home);
var _litHtml = require("lit-html");
var _margheritaJpg = require("/server/assets/margherita.jpg");
var _margheritaJpgDefault = parcelHelpers.interopDefault(_margheritaJpg);
const Home = ()=>(0, _litHtml.html)`
  <section id="home">
    <h2>Welcome to our Pizza Place!</h2>
    <p>Order the best pizza in town.</p>
    <img src="${0, _margheritaJpgDefault.default}" alt="Home Pizza" width="300">
  </section>
`;

},{"lit-html":"1cmQt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","/server/assets/margherita.jpg":"5dKNa"}],"5dKNa":[function(require,module,exports) {
module.exports = require("a57c2d87b295ddf6").getBundleURL("bLxZJ") + "margherita.6aa67329.jpg" + "?" + Date.now();

},{"a57c2d87b295ddf6":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"auGqW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchPizzaImages = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get("http://localhost:5000/api/pizzas");
        (0, _stateJs.state).pizzas = response.data;
        (0, _indexJs.renderApp)();
    } catch (error) {
...
const Menu = ()=>{
    if (!(0, _stateJs.state).pizzas.length) fetchPizzaImages();
    return (0, _litHtml.html)`
    <section id="menu">
      <h2>Menu</h2>
      <div id="pizza-list">
        ${(0, _stateJs.state).pizzas.map((pizza)=>(0, _litHtml.html)`
            <div class="pizza-item">
              <img src="${pizza.image}" alt="${pizza.name}" width="100">
              <h3>${pizza.name}</h3>
              <p>$${pizza.price}</p>
              <button @click=${()=>(0, _stateJs.addToCart)(pizza)}>Add to Cart</button>
            </div>
          `)}
      </div>
    </section>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lit-html":"1cmQt","../state/state.js":"k3jRp","axios":"jo6P5","../index.js":"8lqZg"}],"jo6P5":[function(require,module,exports) {
...
<button @click=${submitOrder}>Submit Order</button>
  <section id="cart">
    <h2>Your Cart</h2>
    <div id="cart-items">
      ${(0, _stateJs.state).cart.length > 0 ? (0, _stateJs.state).cart.map((item)=>(0, _litHtml.html)`
              <div class="cart-item">
                <p>${item.name} - $${item.price}</p>
                <button @click=${()=>(0, _stateJs.removeFromCart)(item)}>Remove</button>
              </div>
            `) : (0, _litHtml.html)`<p>Your cart is empty.</p>`}
    </div>
  </section>
`;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lit-html":"1cmQt","../state/state.js":"k3jRp"}],"8pPOA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Footer", ()=>Footer);
var _litHtml = require("lit-html");
const Footer = ()=>(0, _litHtml.html)`
  <footer>
    <p>&copy; 2024 Pizza Order App</p>
  </footer>
`;

},{"lit-html":"1cmQt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["farZc","8lqZg"], "8lqZg", "parcelRequirec3db")
